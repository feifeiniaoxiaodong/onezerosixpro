...
//			alarmInformation=start.GetAlarminfo(cncNumber);
    ...
    /*	String alarmnum=alarmInformation.getAlarmnum().trim();//报警个数
    	if(alarmnum!=null && !alarmnum.equals("")){		//
    		int alarmCount=Integer.parseInt(alarmnum);
    		if(alarmCount>0){
    			...
    			for(int i=0;i<alarmCount;i++){
    				...
    				sbalram.append(alarmInfo).append(":");
    			}
