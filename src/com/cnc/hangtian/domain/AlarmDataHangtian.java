 ...
 * @author wei
 */
public class AlarmDataHangtian {
	...
	public AlarmDataHangtian() {
		
	}
	
	
	
	public AlarmDataHangtian(String type, int alarmcode,
			String alarmtime_occur, long alarmtime_remove, String alarmnum,
			String timestamp, int[] alarmcode_array,
			String[] alarmtime_occur_array, String[][] warn) {
